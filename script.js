document.addEventListener('DOMContentLoaded', () => {
    ...
    translations.mk.fcShkupiVideoTitle = "Погледнете ја поддршката во акција";

    translations.tr.fcShkupiTitle = "Favori Takımına Destek: FC Shkupi";
    translations.tr.fcShkupiParagraph1 = "FC Shkupi, Makedonya 1. Ligi'nde mücadele ediyor ve bu sezon sahada ve saha dışında zorlu bir dönemden geçiyor. Kulübün kış döneminde güçlü kalmasına yardımcı olmak için, Besar Elezi'nin öncülüğündeki Ragazzi Fastfood & Pizza, takımın kışlık antrenman kıyafetlerini sponsor olarak karşıladı.";
    translations.tr.fcShkupiParagraph2 = "Bu destek, oyunculara ihtiyaç duydukları ekipmanı sağlamakla kalmıyor, aynı zamanda net bir mesaj veriyor: şehirdeki insanlar kendi takımlarının arkasında duruyor. Besar'a göre, bu şehirde yaşayan herkes kendi kulübünü desteklemeli. Onun katkısı sadece maddi yardım değil, FC Shkupi için inanç, motivasyon ve birliktelik anlamına geliyor.";
    translations.tr.fcShkupiVideoTitle = "Desteği sahada izleyin";
    ...
    const menuCardData = { "PIZZA":{title:"Pick Your Pizza",items:[{name:'PIZZA MARGARITA',image:'https://i.imgur.com/YSLS4Pp.png',theme:{bgGradient:'linear-gradient(135deg, #e74c3c, #c0392b)',bgElements:['🍅','🧀','🌿'],textColor:'#ffffff',accentColor:'#FFD700',isCalzone:!1}},{name:'PIZZA FUNGHI',image:'https://i.imgur.com/qeZbEEK.png',theme:{bgGradient:'linear-gradient(135deg, #8B4513, #A0522D)',bgElements:['🍄','🧀','🌿'],textColor:'#ffffff',accentColor:'#FFD700',isCalzone:!1}},{name:'PIZZA TUNA',image:'https://i.imgur.com/UYjPtl2.png',theme:{bgGradient:'linear-gradient(135deg, #3498db, #2980b9)',bgElements:['🐟','🧅','🌊'],textColor:'#ffffff',accentColor:'#FFD700',isCalzone:!1}},{name:'PIZZA SUXHUK',image:'https://i.imgur.com/LDk4NV4.png',theme:{bgGradient:'linear-gradient(135deg, #e67e22, #d35400)',bgElements:['🌭','🧀','🌶️'],textColor:'#ffffff',accentColor:'#FFD700',isCalzone:!1}},{name:'PIZZA PROSCIUTTO',image:'https://i.imgur.com/pAs9K3M.png',theme:{bgGradient:'linear-gradient(135deg, #9b59b6, #8e44ad)',bgElements:['🍖','🧀','🥬'],textColor:'#ffffff',accentColor:'#FFD700',isCalzone:!1}},{name:'PIZZA CAPRICCIOSA',image:'https://i.imgur.com/UiMfyNV.png',theme:{bgGradient:'linear-gradient(135deg, #7e57c2, #5e35b1)',bgElements:['🍖','🍄','🫒'],textColor:'#ffffff',accentColor:'#FFD700',isCalzone:!1}},{name:'PIZZA QUATTRO FORMAGGI',image:'https://i.imgur.com/1ojUNVW.png',theme:{bgGradient:'linear-gradient(135deg, #ffd54f, #ffc107)',bgElements:['🧀','🧀','🧀'],textColor:'#3e2723',accentColor:'#d35400',isCalzone:!1}},{name:'PIZZA CALZONE',image:'https://i.imgur.com/4glW04Z.png',theme:{bgGradient:'linear-gradient(135deg, #ff7043, #f4511e)',bgElements:['🥟','🍖','🍄'],textColor:'#3e2723',accentColor:'#FFD700',isCalzone:!0}},{name:'PIZZA VEGETARIAN',image:'https://i.imgur.com/7aNBE1u.png',theme:{bgGradient:'linear-gradient(135deg, #66bb6a, #43a047)',bgElements:['🥦','🍅','🫑'],textColor:'#1b5e20',accentColor:'#FFD700',isCalzone:!1}},{name:'PIZZA DURUM',image:'https://i.imgur.com/kgL4KnM.png',theme:{bgGradient:'linear-gradient(135deg, #8d6e63, #6d4c41)',bgElements:['🌯','🍖','🍄'],textColor:'#ffffff',accentColor:'#FFD700',isCalzone:!1}},{name:'PIZZA RAGAZZI',image:'https://i.imgur.com/6N3P5gn.png',theme:{bgGradient:'linear-gradient(135deg, #e53935, #c62828)',bgElements:['🍕','🍖','🌶️'],textColor:'#ffffff',accentColor:'#FFD700',isCalzone:!1}}]}, "BAGUETTE": { title: "Choose Your Baguette", items: [{ name: 'CHICKEN BAGUETTE', image: 'https://i.imgur.com/YYcTLWB.png', theme: { bgGradient: 'linear-gradient(135deg, #f7b733, #fc4a1a)', bgElements: ['🥖', '🍗', '🥬'], textColor: '#ffffff', accentColor: '#FFD700' } }, { name: 'ADANA BAGUETTE', image: 'https://i.imgur.com/jAx7ozx.png', theme: { bgGradient: 'linear-gradient(135deg, #D31027, #EA384D)', bgElements: ['🥖', '🌶️', '🥩'], textColor: '#ffffff', accentColor: '#FFD700' } }, { name: 'SUXHUK BAGUETTE', image: 'https://i.imgur.com/luubq25.png', theme: { bgGradient: 'linear-gradient(135deg, #c0392b, #8e44ad)', bgElements: ['🥖', '🌭', '🧀'], textColor: '#ffffff', accentColor: '#FFD700' } }, { name: 'PLESKAVIC BAGUETTE', image: 'https://i.imgur.com/b3YKVLA.png', theme: { bgGradient: 'linear-gradient(135deg, #4b6cb7, #182848)', bgElements: ['🥖', '🍔', '🧅'], textColor: '#ffffff', accentColor: '#FFD700' } }] }, "PIDE": { title: "Pick Your Pide", items: [{ name: 'PIDE ME KACKAVALL', image: 'https://i.imgur.com/2w3kloI.png', theme: { bgGradient: 'linear-gradient(135deg, #FFC837, #FF8008)', bgElements: ['🥖', '🧀'], textColor: '#ffffff', accentColor: '#FFD700' } }, { name: 'PIDE ME SUXHUK', image: 'https://i.imgur.com/bDSrUcH.png', theme: { bgGradient: 'linear-gradient(135deg, #e53935, #c62828)', bgElements: ['🥖', '🌭', '🌶️'], textColor: '#ffffff', accentColor: '#FFD700' } }, { name: 'PIDE ME MISH TE BLUAR', image: 'https://i.imgur.com/iV8bvsY.png', theme: { bgGradient: 'linear-gradient(135deg, #783a00, #c35a00)', bgElements: ['🥖', '🥩', '🧅'], textColor: '#ffffff', accentColor: '#FFD700' } }, { name: 'PIDE ME STEK, VEZE & SUSAM', image: 'https://i.imgur.com/0nt7iUm.png', theme: { bgGradient: 'linear-gradient(135deg, #434343, #000000)', bgElements: ['🥖', '🍳', '🥩'], textColor: '#ffffff', accentColor: '#FFD700' } }, { name: 'PIDE ME TUNA', image: 'https://i.imgur.com/yNzZ5t9.png', theme: { bgGradient: 'linear-gradient(135deg, #00c6ff, #0072ff)', bgElements: ['🥖', '�', '🌽'], textColor: '#ffffff', accentColor: '#FFD700' } }, { name: 'PIDE ME PROSHUTE', image: 'https://i.imgur.com/NTuwILL.png', theme: { bgGradient: 'linear-gradient(135deg, #ec77ab, #7873f5)', bgElements: ['🥖', '🍖', '🌿'], textColor: '#ffffff', accentColor: '#FFD700' } }, { name: 'PIDE RAGAZZI', image: 'https://i.imgur.com/NgbiDKs.png', theme: { bgGradient: 'linear-gradient(135deg, #ff00cc, #333399)', bgElements: ['🥖', '✨', '👨‍🍳'], textColor: '#ffffff', accentColor: '#FFD700' } }] }, "PORTION": { title: "Choose Your Portion", items: [{ name: 'GISHTA PULE', image: 'https://i.imgur.com/oyKT9e6.png', theme: { bgGradient: 'linear-gradient(135deg, #FFD700, #FBB034)', bgElements: ['🍗', '🍟', '😋'], textColor: '#000000', accentColor: '#D32F2F' } }, { name: 'PLESKAVIC SHARRI', image: 'https://i.imgur.com/m4TNFiC.png', theme: { bgGradient: 'linear-gradient(135deg, #7f5a83, #0d324d)', bgElements: ['🍔', '🧅', '🔥'], textColor: '#ffffff', accentColor: '#FFD700' } }, { name: 'SALLATE ME PULE', image: 'https://i.imgur.com/xjd5FNE.png', theme: { bgGradient: 'linear-gradient(135deg, #56ab2f, #a8e063)', bgElements: ['🥗', '🍗', '🍅'], textColor: '#ffffff', accentColor: '#FFD700' } }] }, "TOSTA": { title: "Pick Your Toast", items: [{ name: 'TOST ME SALLAM', image: 'https://i.imgur.com/cutD45v.png', theme: { bgGradient: 'linear-gradient(135deg, #e67e22, #d35400)', bgElements: ['🥪', '🧀'], textColor: '#ffffff', accentColor: '#FFD700' } }, { name: 'TOST ME SUXHUK', image: 'https://i.imgur.com/8WCgONz.png', theme: { bgGradient: 'linear-gradient(135deg, #C04848, #480048)', bgElements: ['🥪', '🌶️', '🌭'], textColor: '#ffffff', accentColor: '#FFD700' } }, { name: 'TOST ME PROSHUTE & QIPS', image: 'https://i.imgur.com/sOfP7k7.png', theme: { bgGradient: 'linear-gradient(135deg, #1c92d2, #f2fcfe)', bgElements: ['🥪', '🍖', '🇮🇹'], textColor: '#000000', accentColor: '#D32F2F' } }] }, "BURGER": { title: "Build Your Burger", items: [{ name: 'BURGER CLASSIC', image: 'https://i.imgur.com/j4XFRfn.png', theme: { bgGradient: 'linear-gradient(135deg, #c21500, #ffc500)', bgElements: ['🍔', '🥩', '🥬'], textColor: '#ffffff', accentColor: '#FFD700' } }, { name: 'CHEESE BURGER', image: 'https://i.imgur.com/kQbvfDj.png', theme: { bgGradient: 'linear-gradient(135deg, #ffc500, #c21500)', bgElements: ['🍔', '🧀', '😋'], textColor: '#ffffff', accentColor: '#FFD700' } }, { name: 'CHICKEN BURGER', image: 'https://i.imgur.com/OVKD1yV.png', theme: { bgGradient: 'linear-gradient(135deg, #DAA520, #B8860B)', bgElements: ['🍔', '🍗', '🍟'], textColor: '#ffffff', accentColor: '#FFD700' } }, { name: 'CRISPY CHICKEN BURGER', image: 'https://i.imgur.com/qkYOjl2.png', theme: { bgGradient: 'linear-gradient(135deg, #FF8C00, #FFD700)', bgElements: ['🍔', '�', '💥'], textColor: '#000000', accentColor: '#B22222' } }, { name: 'BURGER RAGAZZI', image: 'https://i.imgur.com/Q9eycWS.png', theme: { bgGradient: 'linear-gradient(135deg, #2c3e50, #000000)', bgElements: ['🍔', '✨', '🔥'], textColor: '#ffffff', accentColor: '#DAA520' } }] }, "LAHMAXHUN": { title: "Choose Your Lahmacun", items: [{ name: 'LAHMAXHUN', image: 'https://i.imgur.com/Fk88h8g.png', theme: { bgGradient: 'linear-gradient(135deg, #8B4513, #CD853F)', bgElements: ['🫓', '🥩', '🍋'], textColor: '#ffffff', accentColor: '#FFD700' } }, { name: 'LAHMAXHUN ME KACKAVALL', image: 'https://i.imgur.com/T4PTzz0.png', theme: { bgGradient: 'linear-gradient(135deg, #CD853F, #8B4513)', bgElements: ['🫓', '🧀', '🥩'], textColor: '#ffffff', accentColor: '#FFD700' } }] }, "PIZZA FOR KIDS": { title: "For Our Little Guests", items: [{ name: 'PIZZA MICKEY MOUSE', image: 'https://i.imgur.com/or7yDbi.png', theme: { bgGradient: 'linear-gradient(135deg, #ff4e50, #f9d423)', bgElements: ['🍕', '🐭', '🎈'], textColor: '#ffffff', accentColor: '#FFD700' } }, { name: 'PIZZA ME ZEMER', image: 'https://i.imgur.com/tLhY1b0.png', theme: { bgGradient: 'linear-gradient(135deg, #e96443, #904e95)', bgElements: ['🍕', '❤️', '💕'], textColor: '#ffffff', accentColor: '#f9d423' } }] }, "EXTRAS": { title: "Add Something Extra", items: [{ name: 'POMFRIT', image: 'https://i.imgur.com/uFLGVqz.png', theme: { bgGradient: 'linear-gradient(135deg, #f9d423, #ff4e50)', bgElements: ['🍟'], textColor: '#ffffff', accentColor: '#d32f2f' } }, { name: 'SOS HUDHRES', image: 'https://i.imgur.com/pauilZK.png', theme: { bgGradient: 'linear-gradient(135deg, #1A6331, #FFD700)', bgElements: ['🧄', '💧'], textColor: '#ffffff', accentColor: '#ffffff', ingredientTheme: 'light', navTheme: 'light' } }, { name: 'KACKAVALL', image: 'https://i.imgur.com/1WqtWn9.png', theme: { bgGradient: 'linear-gradient(135deg, #ffc500, #9b870c)', bgElements: ['🧀'], textColor: '#ffffff', accentColor: '#d35400' } }, { name: 'SUXHUK', image: 'https://i.imgur.com/OwXFEvQ.png', theme: { bgGradient: 'linear-gradient(135deg, #c21500, #800000)', bgElements: ['🌭', '🌶️'], textColor: '#ffffff', accentColor: '#f9d423' } }, { name: 'VEZE', image: 'https://i.imgur.com/FYthOoh.png', theme: { bgGradient: 'linear-gradient(135deg, #FFD700, #2EAD56)', bgElements: ['🍳'], textColor: '#ffffff', accentColor: '#ffc500' } }, { name: 'PIJE FRESKUESE', image: 'https://i.imgur.com/ZFaSPMN.png', theme: { bgGradient: 'linear-gradient(135deg, #00c6ff, #0072ff)', bgElements: ['🥤', '🧊', '💧'], textColor: '#ffffff', accentColor: '#f5f5f5' } }] }, };
    ...
    /**
     * The main router function. It reads the URL hash and updates the page state accordingly.
     * This is the single source of truth for page navigation.
     */
    /**
     * Updates the page title and meta description based on the current content.
     */
    function updateTitleAndMeta() {
        const pageKey = document.querySelector('.page.active')?.id.replace('-page', '');
        const siteName = 'Ragazzi Fast Food & Pizza';
        let title = siteName;
        ...
        if (pageKey === 'menu' && menuData[activeMenuKey]?.items?.[currentItemIndex]) {
            ...
            description = translations[currentLang]?.['aboutTitle'] || 'Learn about our story and passion for great food.';
        } else {
            title = siteName;
        }
    ...
    function handleUrlChange() {
        ...
        if (parts.length === 0) {
            ...
            if (translations.hasOwnProperty(parts[0])) {
                ...
                if (pageKey === 'menu' && parts[2]) {
                    menuKey = parts[2].toUpperCase().replace(/-/g, ' ');
        ...
        if (pageKey === 'menu') {
            ...
            if (itemSlug) {
                const menu = menuData[targetMenuKey];
                if (menu) {
                    const targetIndex = menu.items.findIndex(item => slugify(item.name) === itemSlug);
                    if (targetIndex !== -1) {
     ...
     * @param {string} lang - The new language code (e.g., 'en', 'sq').
     */
    ...
    /**
     * Switches the displayed menu category.
     * @param {string} newMenuKey - The key of the new menu category (e.g., 'PIZZA').
     */
    async function switchMenuCategory(newMenuKey) {
        if (activeMenuKey === newMenuKey) return;
        activeMenuKey = newMenuKey;
        currentItemIndex = 0; // Reset to the first item when category changes
        ...
        renderCurrentMenuItem();
        await waitForImageLoad(itemImageEl);
    ...
    function setupEventListeners() {
        ...
        // General click listener for closing dropdowns, modals, etc.
        ...
        // Keyboard navigation for menu and modals
    ...
    function preloadMenuImages() {
        Object.values(menuCardData).forEach(category => {
            if (category.items) {
    ...
    function applyTheme(theme) {
        ...
        if (pizzaDisplay) pizzaDisplay.style.setProperty('--accent-color', theme.accentColor);
    ...
    function renderCurrentMenuItem() {
        ...
        // FIX: Added guard for robustness
        if (!menu || !menu.items || menu.items.length === 0) {
            if(pizzaDisplay) pizzaDisplay.style.display = 'none';
            if(menuTitleEl) menuTitleEl.textContent = "Coming Soon!"; // Safe fallback
            if(floatingElements) floatingElements.innerHTML = '';
            updateTitleAndMeta(); // Update title even for empty menu
            return;
        }
        ...
        if(menuTitleEl) {
            // FIX: Simplified logic using the new standardized menuData
            const menuTitleKey = menu.titleKey;
            menuTitleEl.textContent = translations[currentLang][menuTitleKey] || activeMenuKey;
        }
        if(itemNameEl) itemNameEl.textContent = translations[currentLang][item.nameKey] || item.name;
        if(itemDescriptionEl) itemDescriptionEl.textContent = translations[currentLang][item.descriptionKey] || "Description not available";
        ...
        if(ingredientsListEl) {
            ...
            if (ingredientsString) {
                ingredientsString.split(',').forEach(ingredient => {
        ...
        if (sizeSelector) sizeSelector.style.display = activeMenuKey === 'PIZZA' ? 'flex' : 'none';
        ...
        // Update the page title and meta description when menu item changes
        updateTitleAndMeta();
    ...
    /**
     * Updates the WhatsApp button link with the selected item.
     */
    function updateWhatsAppLink() {
        if (!whatsappBtn) return;
        const baseWhatsAppUrl = 'https://wa.me/38971519418';
        if (selectedItemForOrder) {
            const message = `Hello, I would like to order: ${selectedItemForOrder}`;
            const encodedMessage = encodeURIComponent(message);
            whatsappBtn.href = `${baseWhatsAppUrl}?text=${encodedMessage}`;
        } else {
            whatsappBtn.href = baseWhatsAppUrl;
        }
    }

    /**
     * Shows the phone modal and captures the current item for ordering.
     */
    function showPhoneModal() {
        const menu = menuData[activeMenuKey];
        if (document.getElementById('menu-page').classList.contains('active') && menu && menu.items[currentItemIndex]) {
            const item = menu.items[currentItemIndex];
            const itemName = translations[currentLang][item.nameKey] || item.name;

            if (activeMenuKey === 'PIZZA') {
                const sizeMap = { small: '(S)', medium: '(M)', family: '(F)' };
                selectedItemForOrder = `${itemName} ${sizeMap[selectedSize] || ''}`.trim();
            } else {
                selectedItemForOrder = itemName;
            }
        } else {
    ...
    /**
     * Hides the phone modal and resets the order item.
     */
